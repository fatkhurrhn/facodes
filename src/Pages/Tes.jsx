...
const Projects = () => {
  // Sample data dengan tambahan links untuk setiap button
  const projectsData = [
    {
      id: 'repo-sync',
      title: 'Repo Sync',
  ...
  const templatesData = [
    {
      ...
      date: '2023-09-10',
      links: {
        download: 'https://example.com/template-01/download',
        demo: 'https://example.com/template-01/demo',
        code: 'https://github.com/fatkhurrhn/portfolio-template'
      }
    }
  ];
  ...
  const componentsData = [
    {
      ...
      date: '2023-12-05',
      links: {
        download: 'https://example.com/auth-components/download',
        demo: 'https://example.com/auth-components/demo',
        code: 'https://github.com/fatkhurrhn/auth-components'
      }
    }
  ];
